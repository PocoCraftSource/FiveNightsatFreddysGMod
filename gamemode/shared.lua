...
GM.Author 	= "PocoCraft"
GM.Email 	= "poco@pococraft.org"
GM.Website 	= "www.pococraft.org"
...
team.SetUp( 1, "Guest", Color( nil ) ) //Team guest
team.SetUp( 2, "Admin", Color( nil ) ) //Team admin
team.SetUp( 3, "JeromeCrackie", Color( nil ) ) //It's not me!  
team.SetUp( 4, "Joining", Color( nil ) ) //Joining
//team.SetUp( 5, "Donator", Color( 0, 255, 125, 255 ) ) //Team donator
